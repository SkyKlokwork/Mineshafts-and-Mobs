...
public class RolledScreen extends StatSelectionScreen {
    public RolledScreen(Screen parent) {
        super(Text.translatable("mnm.rolled"), parent);
    ...
    public void init() {
        ...
        for (int i=0;i<3;i++){
            textRow3[i] = new TextWidget(Text.translatable("mnm.score.racial","+",0),this.textRenderer);
        ...
        SimplePositioningWidget.setPos(scoreDescription, 0, displayY, this.width, this.height, 0.5f, 0.25f);
